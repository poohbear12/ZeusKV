...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.Raft.HelloRequest,
      com.example.grpc.Raft.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.grpc.Raft.HelloRequest.class,
      responseType = com.example.grpc.Raft.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.Raft.HelloRequest,
      com.example.grpc.Raft.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.Raft.HelloRequest, com.example.grpc.Raft.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.Raft.HelloRequest, com.example.grpc.Raft.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.Raft.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.Raft.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     * <pre>
     * 定义方法：客户端发送一个请求，服务器返回一个响应
     * </pre>
     */
    default void sayHello(com.example.grpc.Raft.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.Raft.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
     ...
     * </pre>
     */
    public void sayHello(com.example.grpc.Raft.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.Raft.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
     ...
     * </pre>
     */
    public com.example.grpc.Raft.HelloResponse sayHello(com.example.grpc.Raft.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.Raft.HelloResponse> sayHello(
        com.example.grpc.Raft.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.grpc.Raft.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.Raft.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpc.Raft.HelloRequest,
              com.example.grpc.Raft.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.Raft.getDescriptor();
    }
